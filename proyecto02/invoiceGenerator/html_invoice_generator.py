"""
Generador de facturas usando HTML/CSS y conversión a PDF
Versión mejorada con soporte para logo y mejor fidelidad HTML-to-PDF
"""
...
class HTMLInvoiceGenerator:
    ...
    def generate_invoice_html(self, company_data, client_data, items, logo_path=None):
        ...
        if logo_path and os.path.exists(logo_path):
            ...
            if logo_base64:
                ...
                print(f"⚠️ No se pudo cargar el logo desde: {logo_path}")
        else:
            ...
            <head>
                ...
                <style>
                    * {{
                    ...
                    .invoice-info-cell {{
                        width: 220px;
                        background-color: #61b21c !important;
    ...
    def convert_to_pdf_pdfkit(self, html_path, pdf_path):
        ...
        try:
            ...
            print("⚠️ pdfkit no está instalado. Instala con: pip install pdfkit")
            print("⚠️ También necesitas wkhtmltopdf: https://wkhtmltopdf.org/downloads.html")
            return None
        except Exception as e:
            print(f"⚠️ Error al generar PDF: {e}")
            return None
...
if __name__ == "__main__":
    ...
    result = generator.generate_invoice(
        ...
        logo_path="invoiceGenerator\logo.png"  # Coloca tu logo aquí
    )
